...
class TraveliaDatabaseHelper extends SQLiteOpenHelper {
    ...
    private void updateMyDatabase(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (oldVersion < 1) {
            ...
            insertSight(db, "Свято-Борисо-Глебская (Коложская) церковь ",
                    ...
                    R.drawable.coloja);
            insertSight(db, "Старый или Верхний замок (ул. Замковая, 22)",
                    ...
                    "Интересный факт. Въездной кирпичный арочный мост в замок, построенный вместо деревянного во второй половине XVII в., на сегодняшний день является старейшим мостом в Беларуси.\n" +
                    ...
                    R.drawable.starzam);
            insertSight(db, "Кафедральный костёл Св. Франциска Ксаверия (пл. Советская, 4) ",
                    ...
                    "Интересные факты. Часы в Северной башне костёла являются одними из старейших действующих механических часов в Восточной Европе. Первоначально, в XVI веке, часы находились в башне городской ратуши, разрушенной во время войны 1654-1667 годов. В 1725 году их перенесли и установили в звоннице костела Франциска Ксаверия. \n" +
                            "Рядом в соседнем здании, построенном в 1709 г., до сего дня работает самая старая в Беларуси аптека-музей (первое упоминание аптеки иезуитов относится к 1687 году).\n" +
    ...
    private static void insertSight(SQLiteDatabase db, String name,
        ...
        db.insert("SIGHTS", null, sightsValues);
    }
