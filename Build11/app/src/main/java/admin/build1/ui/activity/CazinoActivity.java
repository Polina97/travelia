...
public class CazinoActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,
        LoaderManager.LoaderCallbacks<Cursor>,
        CasinoAdapter.CasinoOnClickListener {

    private static final int CASINO_LOADER_ID = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cazino);
        ...
        getSupportLoaderManager().initLoader(CASINO_LOADER_ID, null, this);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        return new TraveliaCursorLoaderCasino(this, TraveliaDatabaseHelper.getInstance(this));
    }

    @Override
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        mRecycler.setAdapter(new CasinoAdapter(data, this));
    }
