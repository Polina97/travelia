...
public class FunAdapter extends RecyclerView.Adapter<FunAdapter.FunViewHolder> {
    ...
    private final FunOnClickListener mListener;

    public FunAdapter(Cursor cursor, FunOnClickListener listener) {
        mCursor = cursor;
        mListener = listener;
    }
    ...
    public FunViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new FunViewHolder(view, mListener);
    }
    ...
    class FunViewHolder extends RecyclerView.ViewHolder {
        ...
        public FunViewHolder(View itemView, final FunOnClickListener listener) {
            super(itemView);
